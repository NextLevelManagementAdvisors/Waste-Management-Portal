      ...
      {stats ? (
        <div className="space-y-4">
          <div className="grid grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            <StatCard label="Total Locations" value={stats.totalLocations} icon={<BuildingOffice2Icon className="w-8 h-8" />} onClick={() => onNavigate('operations', { tab: 'service-areas' })} />
            ...
            <StatCard label="Active Subscriptions" value={stats.activeSubscriptions} icon={<ChartPieIcon className="w-8 h-8" />} onClick={() => onNavigate('accounting', { tab: 'income' })} />
