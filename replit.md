...
**Key Features:**
- **Admin Dashboard:** A comprehensive admin portal at `/admin/` with analytics, customer management, billing tools, operations views, audit logging, global search, customer impersonation, driver impersonation, role-based permissions (Full Admin / Support / Viewer), and bulk customer actions (notify via email/SMS, grant/revoke admin).
