...
const Login: React.FC<LoginProps> = ({ onLogin, switchToRegister, switchToForgotPassword, error, pendingQueryString, prefillEmail }) => {
    ...
    return (
        <div>
            ...
            <div className="mb-6">
                <a
                    href={`/api/auth/google${pendingQueryString ? `?${pendingQueryString}` : ''}`}
                    className="w-full flex items-center justify-center gap-3 px-4 py-2.5 border border-gray-300 rounded-md shadow-sm bg-white hover:bg-gray-50 transition-colors font-medium text-gray-700"
                >
